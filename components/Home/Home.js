...
import SplitLogo from "../../public/images/split/pragya-1.png";
            ...
            <div className="col-lg-12">
              <div className="inner text-center mt--140">
                <h1 className="title display-one">
                  An on demand evaluation and assessment solution for
                  <br />{" "}
                ...
                <p className="description">
                  Accelerate your assessment processes with AI. Build
                  customizable evaluation criteria for interviews, exams,
                  training,and more…
                  <br />
                </p>
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                ...
                <h2 className="title mb--0" style={{ fontSize: "30px" }}>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle">
                  <span className="theme-gradient">Scalable Technology</span>
                </h4>
                <h2 className="title mb--60">Harness the power of AI</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle ">
                  <span className="theme-gradient">AI Powered</span>
                </h4>
                <h2 className="title mb--20">
                  An evaluation Co-Pilot to assist
                  <br />
                  you make most informed decisions
                </h2>
                <Link
